...
$templates = [
    ...
    'trade-offer-received' => [
        ...
        'body' => "<div class='header' style='background-color: #dcb377; color: white; padding: 20px; text-align: center; border-radius: 5px;'><h2>New Trade Offer Received! 🔄</h2></div><div class='content' style='padding: 20px; background-color: #f9f9f9; margin: 20px 0; border-radius: 5px;'><p>You have received a new trade offer for your vehicle: <strong>[target_car_title]</strong></p><h3>Offered Vehicle Details:</h3><ul><li><strong>Title:</strong> [offered_car_title]</li><li><strong>Brand:</strong> [offered_car_brand]</li><li><strong>Model:</strong> [offered_car_model]</li><li><strong>Year:</strong> [offered_car_year]</li></ul><h3>Sender Information:</h3><ul><li><strong>Name:</strong> [sender_name]</li><li><strong>Email:</strong> [sender_email]</li><li><strong>Phone:</strong> [sender_phone]</li></ul><div style='background-color: #fff9e6; padding: 15px; border-left: 4px solid #dcb377; margin-top: 15px;'><strong>Comment:</strong><p>[comment]</p></div></div>",
        'shortcodes' => ['target_car_title', 'car_title', 'offered_car_title', 'offered_car_brand', 'offered_car_model', 'offered_car_year', 'sender_name', 'sender_email', 'sender_phone', 'comment'],
    ],
];
