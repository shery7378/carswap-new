...
class SettingController extends Controller
{
    ...
    {
        $filteredSettings = Cache::remember('carswap_settings_public', 86400, function () {
            ...
            $defaults = [
                ...
                'footer_mailing_list_subtitle' => 'Stay updated with our latest offers.',
            ...
            return array_intersect_key($finalSettings, array_flip($publicKeys));
        });
