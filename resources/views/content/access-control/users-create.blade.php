...
<style>
  ...
  .module-perm-card {
    border:1.5px solid #e9ecef; border-radius:12px; overflow:hidden; margin-bottom:16px; transition:box-shadow .2s;
  }
  ...
  .module-perm-header {
    ...
    border-bottom:1.5px solid #e9ecef; padding:10px 16px;
    display:flex; align-items:center; justify-content:space-between;
  }
  .module-perm-header .module-name { font-weight:700; font-size:14px; color:#2c2c44; display:flex; align-items:center; gap:8px; }
  .module-perm-body { padding:14px 16px; }
  .perm-action-pill {
    display:inline-flex; align-items:center; gap:6px;
    border:1.5px solid #e2e3ff; border-radius:20px;
    padding:5px 14px; margin:4px; cursor:pointer;
...
<div class="d-flex align-items-center mb-4">
  ...
  <h4 class="mb-0">
    ...
    <span class="fw-bold text-primary">Create Administrator</span>
  </h4>
</div>
              ...
              <div class="module-perm-card">
                ...
                <div class="module-perm-body" id="{{ $moduleId }}">
                  ...
                  @php
                    ...
                    $isChecked  = in_array($perm->name, old('permissions', []));
                  @endphp
          ...
          <div class="row mt-5">
            <div class="col-12 d-flex justify-content-end gap-3">
              ...
              <button type="submit" class="btn btn-primary px-5 shadow-sm">
                <i class="bx bx-check-circle me-1"></i> Create Administrator
              </button>
            </div>
          </div>
        </form>
