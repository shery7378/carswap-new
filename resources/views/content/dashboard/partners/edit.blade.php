    ...
    <div class="col-xl-9 col-lg-8">
        <div class="card mb-4">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="mb-0">{{ __('Edit Partner') }}: {{ $partner->name }}</h5>
                <a href="{{ route('admin.partners.index') }}" class="btn btn-sm btn-outline-secondary">{{ __('Back to List') }}</a>
            </div>
            <div class="card-body">
                <form action="{{ route('admin.partners.update', $partner->id) }}" method="POST" enctype="multipart/form-data" id="partnerForm">
                    ...
                    <div class="mb-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 mb-2 d-flex align-items-end justify-content-between">
                                        <div class="form-check mb-2">
                                            ...
                                            <label class="form-check-label" for="service_active_{{ $index }}">{{ __('Published') }}</label>
                                        </div>
                        ...
                        <button type="button" class="btn btn-sm btn-outline-primary" id="add-service">
                            <i class="bx bx-plus me-1"></i>{{ __('Add more services') }}
                        </button>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="address" name="address" value="{{ old('address', $partner->address) }}" placeholder="{{ __('Search for address or enter manually...') }}" required />
                                </div>
        ...
        const html = `
            <div class="service-item border p-3 mb-3 rounded bg-light">
                <div class="row">
                    <div class="col-md-9 mb-2">
                        <label class="form-label">{{ __('Service Name') }}</label>
                        <input type="text" name="services[${serviceIndex}][name]" class="form-control bg-white" placeholder="{{ __('Service Name') }}" required>
                    </div>
                    <div class="col-md-3 mb-2 d-flex align-items-end justify-content-between">
                        <div class="form-check mb-2">
                ...
                <div class="mb-0">
                    <textarea name="services[${serviceIndex}][description]" class="form-control bg-white" rows="2" placeholder="{{ __('Description') }}"></textarea>
                </div>
            </div>
        `;
