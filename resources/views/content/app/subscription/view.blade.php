                ...
                <div class="row">
                    <div class="col-12 text-end">
                        ...
                        <div class="d-flex justify-content-end align-items-center border-top pt-2">
                            ...
                            <span class="fw-bold fs-4 text-primary">HUF {{ number_format($subscription->amount, 0, '.', '') }}</span>
                        </div>
                    </div>
                </div>
                <div class="row mt-4">
                    <div class="col-12">
                        ...
                        <span class="text-muted small">It was a pleasure working with you and your team. We hope you keep using CarSwap. Thank you!</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-xl-3 col-md-4 col-12">
        <div class="card mb-4 border-0 shadow-sm">
            ...
            <div class="card-body pt-4">
                <button class="btn btn-primary d-grid w-100 mb-3" data-bs-toggle="modal" data-bs-target="#editSubscriptionModal">
                ...
                <div class="modal-body">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="plan_id" class="form-select">
                                @foreach($plans as $plan)
                                    <option value="{{ $plan->id }}" {{ $subscription->plan_id == $plan->id ? 'selected' : '' }}>{{ $plan->name }} (HUF {{ number_format((float) $plan->price, 0, '.', '') }})</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Amount Paid</label>
                            <input type="number" step="0.01" name="amount" class="form-control" value="{{ $subscription->amount }}">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Start Date</label>
                            <input type="datetime-local" name="starts_at" class="form-control" value="{{ $subscription->starts_at ? $subscription->starts_at->format('Y-m-d\TH:i') : '' }}">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label">End Date</label>
                            <input type="datetime-local" name="ends_at" class="form-control" value="{{ $subscription->ends_at ? $subscription->ends_at->format('Y-m-d\TH:i') : '' }}">
                        </div>
                    </div>
                    <hr>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="billing_full_name" class="form-control" value="{{ $subscription->billing_full_name }}">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Company Name</label>
                            <input type="text" name="billing_company_name" class="form-control" value="{{ $subscription->billing_company_name }}">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-8 mb-3">
                            <label class="form-label">Address</label>
                            <input type="text" name="billing_address" class="form-control" value="{{ $subscription->billing_address }}">
                        </div>
...
@media print {
    @page { margin: 0; }
    body { margin: 1.6cm; }
    .layout-navbar, .layout-menu, .col-xl-3, .btn-close, .modal, .card-header, .btn, .footer {
